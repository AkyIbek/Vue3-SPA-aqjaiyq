<template>
  <section class="business">
    <div class="business__filters">
      <h1 class="business__filters-title">{{ $t('citizens.item-5') }}</h1>
      <div class="business__filters-content">
    ...
    <div class="business__container">
      <div v-if="showAccordion" class="business__accordion">
        <h1 class="business__accordion-title">{{ $t('citizens.item-2') }}</h1>
        <div class="business__accordion-items">
          <Accordion
      ...
      <div class="business__cards">
        <div v-if="showServices" class="business__cards-services">
          <ServiceCard />
        </div>
        <div v-if="showMaps" class="business__cards-maps">
          <MapsCard />
        </div>
      </div>
    </div>
...
.business__filters-content {
  display: flex;
  gap: 1.5rem;
}
.business__filters-title {
  margin-bottom: 2rem;
}
.business__accordion-items {
  display: flex;
  flex-direction: column;
  gap: 1rem;
}
